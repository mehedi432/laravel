            ...
            <div class="card-body">
                <ul class="list-group clearfix">
                    @foreach ($sura_text as $text)
                        <li class="shadow bg-dark text-white list-group-item font-weight-bolder">  <span class="badge badge-secondary badge-pill text-white font-weight-bolder float-left mr-3" >{{$text->aya}} </span> {{$text->text}}</li>
                    @endforeach
                </ul>
