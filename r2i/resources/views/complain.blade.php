...
<div class="container">
    <div class="card shadow">
        ...
        <form class="form-horizontal" action="complain" method="POST">
            ...
            <div class="form-group">
                <label class="control-label col-sm-12" for="ticket">আমার টিকেট নাম্বার</label>
                <div class="col-sm-12">
                    <input type="text" class="form-control" id="ticket" placeholder="আপনার টিকেট নাম্বার" name="ticket">
                    @error('ticket')
                    {{$message}}
                    @enderror
                </div>
