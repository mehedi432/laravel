...
@section('content')
    <div class="card">
        <div class="card-header text-center clearfix bg-secondary text-white">Post <span class="float-right"><a class="text-white" href="{{route('post.create')}}">Add</a></span></div>
        <div class="card-body">
            @if ($posts->count() > 0)
